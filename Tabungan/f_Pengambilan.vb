...
Public Class f_Pengambilan
    ...
    Sub NomorOtomatis()
        ...
        CMD = New OleDbCommand("select * from pengambilan order by No_Ambil desc", Conn)
        Conn.Close()
        Conn.Open()
    ...
    Sub TampilDataGrid()
        ...
        DA = New OleDbDataAdapter("SELECT * from pengambilan", Conn)
        DS = New DataSet
    ...
    Private Sub btn_simpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_simpan.Click
        ...
        Else
            If MessageBox.Show("Apakah Yakin Akan Menyimpan...?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                Try
                    Call Koneksi()
                    CMD = New OleDbCommand("SELECT No_Ambil from pengambilan WHERE No_Ambil= '" & txtNo_Ambil.Text & "'", Conn)
                    RD = CMD.ExecuteReader
                    RD.Read()
                    If RD.HasRows Then
                    ...
                    Else
                        ...
                        CMD = New OleDbCommand(UpdatesaldoDataSiswa, Conn)
                        CMD.ExecuteNonQuery()
