...
Public Class ReportSetorDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tabungan.ReportSetorDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportSetorDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportSetorDate = New ReportSetorDate
        rpt.Site = Me.Site
        Return rpt
    End Function
