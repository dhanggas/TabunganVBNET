...
Public Class f_Setoran
    ...
    Sub NomorOtomatis()
        ...
        CMD = New OleDbCommand("select * from setoran order by No_Setor desc", Conn)
        Conn.Close()
        Conn.Open()
    ...
    Sub TampilDataGrid()
        ...
        DA = New OleDbDataAdapter("SELECT * from setoran", Conn)
        DS = New DataSet
        DA.Fill(DS, "setoran")
    ...
    Private Sub btn_simpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_simpan.Click
        ...
        Else
            If MessageBox.Show("Apakah Yakin Akan Menyimpan...?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                Try
                    Call Koneksi()
                    CMD = New OleDbCommand("SELECT No_Setor from setoran WHERE No_Setor= '" & txtNo_Setor.Text & "'", Conn)
                    RD = CMD.ExecuteReader
                    RD.Read()
                    If RD.HasRows Then
