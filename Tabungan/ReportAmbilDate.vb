...
Public Class ReportAmbilDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tabungan.ReportAmbilDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportAmbilDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportAmbilDate = New ReportAmbilDate
        rpt.Site = Me.Site
        Return rpt
    End Function
